...
# MOTION_FILES = glob.glob('../../datasets/keti1/*')
...
class Cyberdog2AMPCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        # PD Drive parameters:
        control_type = 'P'
        stiffness = {'hip_joint': 1000, 'thigh_joint': 650, 'calf_joint': 650}  # [N*m/rad]
        damping = {'hip_joint': 20, 'thigh_joint': 15, 'calf_joint': 15}     # [N*m*s/rad]
