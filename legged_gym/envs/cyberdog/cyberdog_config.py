...
class CyberdogRoughCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/cyberdog/urdf/cyberdog.urdf'
        name = "cyberdog"
        foot_name = "foot"
...
class CyberdogFlatCfg( CyberdogRoughCfg ):
    ...
    class asset( CyberdogRoughCfg.asset ):
        self_collisions = 0 # 1 to disable, 0 to enable...bitwise filter

class CyberdogFlatCfgPPO( CyberdogRoughCfgPPO ):
...
class CyberdogMeihuaCfg( CyberdogRoughCfg ):
    class env( CyberdogRoughCfg.env ):
        num_envs = 4096
        num_observations = 363 # 观测空间的维度
    ...
    class rewards( CyberdogRoughCfg.rewards ):
        soft_dof_pos_limit = 0.9
